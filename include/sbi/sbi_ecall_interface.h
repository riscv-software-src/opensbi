...
enum sbi_pmu_fw_event_code_id {
	SBI_PMU_FW_MISALIGNED_LOAD	= 0x0,
	SBI_PMU_FW_MISALIGNED_STORE	= 0x1,
	SBI_PMU_FW_ACCESS_LOAD		= 0x2,
	SBI_PMU_FW_ACCESS_STORE		= 0x3,
	SBI_PMU_FW_ILLEGAL_INSN		= 0x4,
	SBI_PMU_FW_SET_TIMER		= 0x5,
	SBI_PMU_FW_IPI_SENT		= 0x6,
	SBI_PMU_FW_IPI_RECVD		= 0x7,
	SBI_PMU_FW_FENCE_I_SENT		= 0x8,
	SBI_PMU_FW_FENCE_I_RECVD	= 0x9,
	SBI_PMU_FW_SFENCE_VMA_SENT	= 0xa,
	SBI_PMU_FW_SFENCE_VMA_RCVD	= 0xb,
	SBI_PMU_FW_SFENCE_VMA_ASID_SENT	= 0xc,
	SBI_PMU_FW_SFENCE_VMA_ASID_RCVD	= 0xd,

	SBI_PMU_FW_HFENCE_GVMA_SENT	= 0xe,
	SBI_PMU_FW_HFENCE_GVMA_RCVD	= 0xf,
	SBI_PMU_FW_HFENCE_GVMA_VMID_SENT = 0x10,
	SBI_PMU_FW_HFENCE_GVMA_VMID_RCVD = 0x11,

	SBI_PMU_FW_HFENCE_VVMA_SENT	= 0x12,
	SBI_PMU_FW_HFENCE_VVMA_RCVD	= 0x13,
	SBI_PMU_FW_HFENCE_VVMA_ASID_SENT = 0x14,
	SBI_PMU_FW_HFENCE_VVMA_ASID_RCVD = 0x15,

	SBI_PMU_FW_SHADOW_CPU_CYCLES	= 0x16,
	SBI_PMU_FW_SHADOW_INSTRUCTIONS	= 0x17,
	SBI_PMU_FW_MACHINE_CYCLES	= 0x18,
	SBI_PMU_FW_MACHINE_INSTRUCTIONS	= 0x19,
